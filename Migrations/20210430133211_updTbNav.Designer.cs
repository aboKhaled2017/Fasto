...
namespace Fastdo.API.Migrations
{
    ...
    [Migration("20210430133211_updTbNav")]
    partial class updTbNav
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fastdo.Core.Models.BaseCustomer", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("BaseCustomer");
                });
            ...
            modelBuilder.Entity("Fastdo.Core.Models.TechnicalSupportQuestion", b =>
                {
                    ...
                    b.Property<string>("BaseCustomerId");
            ...
            modelBuilder.Entity("Fastdo.Core.Models.Pharmacy", b =>
                {
                    b.HasBaseType("Fastdo.Core.Models.BaseCustomer");
            ...
            modelBuilder.Entity("Fastdo.Core.Models.Stock", b =>
                {
                    ...
                    b.Property<string>("CommercialRegImgSrc")
                        .IsRequired()
                        .HasColumnName("Stock_CommercialRegImgSrc");

                    b.Property<string>("LicenseImgSrc")
                        .IsRequired()
                        .HasColumnName("Stock_LicenseImgSrc");

                    b.Property<string>("MgrName")
                        .IsRequired()
                        .HasColumnName("Stock_MgrName");

                    b.Property<string>("OwnerName")
                        .IsRequired()
                        .HasColumnName("Stock_OwnerName");
            ...
            modelBuilder.Entity("Fastdo.Core.Models.TechnicalSupportQuestion", b =>
                {
                    ...
                    b.HasOne("Fastdo.Core.Models.Admin")
                        .WithMany("TechQuestions")
                        .HasForeignKey("AdminId1");

                    b.HasOne("Fastdo.Core.Models.BaseCustomer")
                        .WithMany("TechQuestions")
                        .HasForeignKey("BaseCustomerId");
