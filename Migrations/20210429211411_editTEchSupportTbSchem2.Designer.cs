...
namespace Fastdo.API.Migrations
{
    ...
    [Migration("20210429211411_editTEchSupportTbSchem2")]
    partial class editTEchSupportTbSchem2
    {
            ...
            modelBuilder.Entity("Fastdo.Core.Models.TechnicalSupportQuestion", b =>
                {
                    ...
                    b.Property<Guid?>("TechnicalSupportQuestionId");
                    ...
                    b.HasIndex("TechnicalSupportQuestionId");
            ...
            modelBuilder.Entity("Fastdo.Core.Models.TechnicalSupportQuestion", b =>
                {
                    ...
                    b.HasOne("Fastdo.Core.Models.Stock")
                        .WithMany("TechQuestions")
                        .HasForeignKey("StockId");

                    b.HasOne("Fastdo.Core.Models.TechnicalSupportQuestion")
                        .WithMany("Responses")
                        .HasForeignKey("TechnicalSupportQuestionId");
                });
